...
namespace ScePSP.Memory
{
    ...
    public abstract unsafe class PspMemory : IPspMemoryInfo, IDisposable
    {
        ...
        public const uint MaxMemoryMask = 0xFFFFFFFF;
        ...
        public virtual T* PspAddressToPointerSafe<T>(uint Address, int Count, bool CanBeNull = true, bool InvalidAsNull = false) where T : unmanaged
        {
