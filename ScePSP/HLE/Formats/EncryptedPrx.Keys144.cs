namespace ScePSP.Hle.Formats
{
    public partial class EncryptedPrx
    {
        ...
        {
			// 1.x PRXs
			new TAG_INFO() { tag = 0x00000000, ikey = g_key0, code = 0x42 },
            new TAG_INFO() { tag = 0x02000000, ikey = g_key2, code = 0x45 },
            new TAG_INFO() { tag = 0x03000000, ikey = g_key3, code = 0x46 },

			// 2.0 PRXs
			new TAG_INFO() { tag = 0x4467415d, ikey = g_key44, code = 0x59, codeExtra = 0x59 },
            new TAG_INFO() { tag = 0x207bbf2f, ikey = g_key20, code = 0x5A, codeExtra = 0x5A },
            new TAG_INFO() { tag = 0x3ace4dce, ikey = g_key3A, code = 0x5B, codeExtra = 0x5B },

			// misc
			new TAG_INFO() { tag = 0x07000000, ikey = g_key_INDEXDAT1xx, code = 0x4A },                    // 1.xx index.dat
			new TAG_INFO() { tag = 0x08000000, ikey = g_keyEBOOT1xx, code = 0x4B },                        // 1.xx game eboot.bin
			new TAG_INFO() { tag = 0xC0CB167C, ikey = g_keyEBOOT2xx, code = 0x5D, codeExtra = 0x5D },      // 2.xx+ game eboot.bin
			
			new TAG_INFO() { tag = 0x0B000000, ikey = g_keyUPDATER, code = 0x4E },                         // updater data.psp
			new TAG_INFO() { tag = 0x0C000000, ikey = g_keyDEMOS27X, code = 0x4F },                        // 2.7x demos
			new TAG_INFO() { tag = 0x0F000000, ikey = g_keyMEIMG250, code = 0x52 },                        // 2.50 meimg and me_sdimg
			new TAG_INFO() { tag = 0x862648D1, ikey = g_keyMEIMG260, code = 0x52, codeExtra = 0x52 },      // 2.60+ meimg and me_sdimg

			new TAG_INFO() { tag = 0x207BBF2F, ikey = g_keyUNK1, code = 0x5A, codeExtra = 0x5A },		  // unknown

			new TAG_INFO() { tag = 0x09000000, ikey = g_key_GAMESHARE1xx, code = 0x4C },                   // gameshare 1.xx
