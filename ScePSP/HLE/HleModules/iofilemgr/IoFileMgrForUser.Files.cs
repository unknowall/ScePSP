        ...
        public class GuestHleIoDriver : IHleIoDriver, IDisposable
        {
            ...
            public int IoClose(HleIoDrvFileArg HleIoDrvFileArg)
            {
                ConsoleUtils.SaveRestoreConsoleColor(ConsoleColor.Red,
                    () => { Console.Error.WriteLine("Not Implemented: GuestHleIoDriver.IoClose"); });
                //throw new NotImplementedException();
                return 0;
            }
            ...
            {
                ConsoleUtils.SaveRestoreConsoleColor(ConsoleColor.Red,
                    () => { Console.Error.WriteLine("Not Implemented: GuestHleIoDriver.IoRead"); });
                //throw new NotImplementedException();
                return 0;
            }
            ...
            {
                ConsoleUtils.SaveRestoreConsoleColor(ConsoleColor.Red,
                    () => { Console.Error.WriteLine("Not Implemented: GuestHleIoDriver.IoWrite"); });
                //throw new NotImplementedException();
                return 0;
            }
