...
namespace ScePSP.Hle.Modules.openpsid
{
    [HlePspModule(ModuleFlags = ModuleFlags.UserMode | ModuleFlags.Flags0x00010011)]
    public unsafe partial class sceOpenPSID : HleModuleHost
    {
        ...
        public int sceOpenPSIDGetOpenPSID(PspOpenPSID* OpenPSID)
        {
            ...
            int n = 0;
            foreach (var Byte in new byte[]
                {0x10, 0x02, 0xA3, 0x44, 0x13, 0xF5, 0x93, 0xB0, 0xCC, 0x6E, 0xD1, 0x32, 0x27, 0x85, 0x0F, 0x9D})
            {
