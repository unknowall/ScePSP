...
namespace ScePSP.Hle.Modules.threadman
{
    public unsafe partial class ThreadManForUser
    {
        ...
        public uint sceKernelCreateThread(CpuThreadState CpuThreadState, string Name,
            uint /*SceKernelThreadEntry*/ EntryPoint, int InitPriority, int StackSize, PspThreadAttributes Attribute,
        ...
        /// </example>
        /// <param name="ThreadId">ID of the thread to get the status of.</param>
        ...
        /// (from <see cref="sceKernelSuspendDispatchThread"/>)
        /// </param>
        /// <returns>0 on success, less than 0 on error</returns>
