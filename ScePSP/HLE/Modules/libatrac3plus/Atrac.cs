...
namespace ScePSP.Hle.Modules.libatrac3plus
{
    public unsafe partial class sceAtrac3plus : HleModuleHost
    {
        ...
        public class Atrac : IHleUidPoolClass
        {
            ...
            public Atrac(PspContext PspContext, CodecType CodecType)
            {
            ...
            public Atrac(PspContext PspContext, byte* Data, int DataLength)
            {
                PspContext.InjectDependencesTo(this);
            ...
            public Atrac(PspContext PspContext, byte* Data, int DataLength, int ReadSize, bool IsMoon = false)
            {
                PspContext.InjectDependencesTo(this);
            ...
            private void ParseAtracData(Stream Stream, byte* Data, int DataLength)
            {
                ...
                Console.WriteLine($"{Format.CompressionCode} Decoder init, BlockSize {Format.BytesPerFrame}");
