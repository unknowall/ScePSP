...
namespace ScePSP.Hle.Modules.libatrac3plus
{
    ...
    public unsafe partial class sceAtrac3plus : HleModuleHost
    {
        ...
        [Context]
        public HleUidPoolManager HleUidPoolManager;
        ...
        private Atrac TryToAlloc(Atrac Atrac)
        {
            ...
            var Count = HleUidPoolManager.List<Atrac>().Count(_Atrac => _Atrac.CodecType == CodecType);
        ...
        {
            return TryToAlloc(new Atrac(PspContext, DataPointer, DataLength));
        }
        ...
        private int _sceAtracDecodeData(Atrac Atrac, StereoShortSoundSample* SamplesOut, out int NumberOfSamples, out int ReachedEnd, out int RemainingFramesToDecode)
        {
            ...
            if (Ret > 0)
            {
                ThreadManForUser.sceKernelDelayThread(2300); // Microseconds, based on PSP tests
            }
        ...
        public Atrac sceAtracGetAtracID(CodecType CodecType)
        {
            ...
            return TryToAlloc(new Atrac(PspContext, CodecType));
        }
        ...
        {
            HleUidPoolManager.RemoveAll<Atrac>();
        ...
        {
            return TryToAlloc(new Atrac(PspContext, HalfBufferPointer, HalfBufferSize, readSize));
        }
        ...
        {
            return TryToAlloc(new Atrac(PspContext, halfBuffer, halfBufferSize, readSize, true));
        }
