...
namespace ScePSP.Hle.Modules.sysmem
{
    ...
    public unsafe class sceSysEventForKernel : HleModuleHost
    {
        ...
        public int sceKernelSysEventDispatch(int EventTypeMask, int EventId, uint EventNamePointer, uint Parameter, uint Result, int BreakNonZero, PspSysEventHandler* BreakHandler)
        {
            /*
