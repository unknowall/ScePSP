...
namespace ScePSP.Hle.Modules.utility
{
    public unsafe partial class sceUtility
    {
        ...
        public struct SizeRequiredSpaceInfo
        {
            ...
            public string RequiredSpaceString { get { fixed (byte* Ptr = RequiredSpaceStringFixed) return PointerUtils.FixedByteGet(8, Ptr); } set { fixed (byte* Ptr = RequiredSpaceStringFixed) PointerUtils.FixedByteSet(8, Ptr, value); } }
            ...
            public string RequiredSpace32KBString { get { fixed (byte* Ptr = RequiredSpace32KBStringFixed) return PointerUtils.FixedByteGet(8, Ptr); } set { fixed (byte* Ptr = RequiredSpace32KBStringFixed) PointerUtils.FixedByteSet(8, Ptr, value); } }
        }
