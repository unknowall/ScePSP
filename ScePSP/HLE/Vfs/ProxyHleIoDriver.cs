namespace ScePSP.Hle.Vfs
{
    public unsafe class ProxyHleIoDriver : IHleIoDriver
    {
        ...
        public virtual int IoDevctl(HleIoDrvFileArg HleIoDrvFileArg, string DeviceName, uint Command, byte* InputPointer, int InputLength, byte* OutputPointer, int OutputLength)
        {
