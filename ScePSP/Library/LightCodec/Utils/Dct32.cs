namespace LightCodec.Utils
{
    ...
    public class Dct32
    {
        ...
        public static readonly float COS0_0 = (float)(0.50060299823519630134 / 2);
        public static readonly float COS0_1 = (float)(0.50547095989754365998 / 2);
        public static readonly float COS0_2 = (float)(0.51544730992262454697 / 2);
        public static readonly float COS0_3 = (float)(0.53104259108978417447 / 2);
        public static readonly float COS0_4 = (float)(0.55310389603444452782 / 2);
        public static readonly float COS0_5 = (float)(0.58293496820613387367 / 2);
        public static readonly float COS0_6 = (float)(0.62250412303566481615 / 2);
        public static readonly float COS0_7 = (float)(0.67480834145500574602 / 2);
        public static readonly float COS0_8 = (float)(0.74453627100229844977 / 2);
        public static readonly float COS0_9 = (float)(0.83934964541552703873 / 2);
        public static readonly float COS0_10 = (float)(0.97256823786196069369 / 2);
        public static readonly float COS0_11 = (float)(1.16943993343288495515 / 4);
        public static readonly float COS0_12 = (float)(1.48416461631416627724 / 4);
        public static readonly float COS0_13 = (float)(2.05778100995341155085 / 8);
        public static readonly float COS0_14 = (float)(3.40760841846871878570 / 8);
        public static readonly float COS0_15 = (float)(10.19000812354805681150 / 32);

        public static readonly float COS1_0 = (float)(0.50241928618815570551 / 2);
        public static readonly float COS1_1 = (float)(0.52249861493968888062 / 2);
        public static readonly float COS1_2 = (float)(0.56694403481635770368 / 2);
        public static readonly float COS1_3 = (float)(0.64682178335999012954 / 2);
        public static readonly float COS1_4 = (float)(0.78815462345125022473 / 2);
        public static readonly float COS1_5 = (float)(1.06067768599034747134 / 4);
        public static readonly float COS1_6 = (float)(1.72244709823833392782 / 4);
        public static readonly float COS1_7 = (float)(5.10114861868916385802 / 16);

        public static readonly float COS2_0 = (float)(0.50979557910415916894 / 2);
        public static readonly float COS2_1 = (float)(0.60134488693504528054 / 2);
        public static readonly float COS2_2 = (float)(0.89997622313641570463 / 2);
        public static readonly float COS2_3 = (float)(2.56291544774150617881 / 8);

        public static readonly float COS3_0 = (float)(0.54119610014619698439 / 2);
        public static readonly float COS3_1 = (float)(1.30656296487637652785 / 4);

        public static readonly float COS4_0 = (float)(0.70710678118654752439 / 2);
