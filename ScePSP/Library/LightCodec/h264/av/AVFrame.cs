...
namespace LightCodec.av
{
    public class AVFrame
    {
        ...
        */
        ...
        public int[][][] ref_poc = Arrays.Create<int>(2, 2, 16);

        ///< h264 POCs of the frames used as reference (FIXME need per slice)
        public int[][] ref_count = Arrays.Create<int>(2, 2);
        ...
        */
            ...
            int is_long, int sel)
        {
            ...
            {
                while (i[0] < len && !(in_base[in_offset + i[0]] != null &&
                                       (in_base[in_offset + i[0]].reference & sel) != 0))
                    i[0]++;
                while (i[1] < len && !(in_base[in_offset + i[1]] != null &&
                                       (in_base[in_offset + i[1]].reference & (sel ^ 3)) != 0))
                    i[1]++;
                if (i[0] < len)
                {
        ...
        public static int add_sorted(AVFrame[] sorted_base, int sorted_offset, AVFrame[] src_base, int src_offset,
