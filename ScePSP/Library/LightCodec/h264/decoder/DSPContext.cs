...
namespace LightCodec.h264.decoder
{
    ...
    {
        public const int FF_NO_IDCT_PERM = 1;
        ...
        public void draw_edges(byte[] buf_base, int buf_offset, int wrap, int width, int height, int w)
        {
            ...
            for (i = 0; i < w; i++)
            {
                Arrays.Fill(buf_base, buf_offset - (i + 1) * wrap - w, buf_offset - (i + 1) * wrap - w + w,
                    buf_base[buf_offset]);
                //memset(buf - (i + 1) * wrap - w, buf[0], w); /* top left */
                Arrays.Fill(buf_base, buf_offset - (i + 1) * wrap + width, buf_offset - (i + 1) * wrap + width + w,
                    buf_base[buf_offset + width - 1]);
                //memset(buf - (i + 1) * wrap + width, buf[width-1], w); /* top right */
                Arrays.Fill(last_line_base, last_line_offset + (i + 1) * wrap - w,
                    last_line_offset + (i + 1) * wrap - w + w, last_line_base[last_line_offset]);
                //memset(last_line + (i + 1) * wrap - w, last_line[0], w); /* top left */
                Arrays.Fill(last_line_base, last_line_offset + (i + 1) * wrap + width,
                    last_line_offset + (i + 1) * wrap + width + w, last_line_base[last_line_offset + width - 1]);
        ...
        public void ff_emulated_edge_mc(byte[] buf_base, int buf_offset, byte[] src_base, int src_offset, int linesize,
         ...
         * h264 Qpel MC
         */
        public delegate void Ih264_qpel_mc_func(byte[] dst_base /*align 8*/, int dst_offset,
            byte[] src_base /*align 1*/, int src_offset, int stride);

        /**
         * h264 Chroma MC
         */
        public delegate void Ih264_chroma_mc_func(byte[] dst_base /*align 8*/, int dst_offset,
            byte[] src_base /*align 1*/, int src_offset, int srcStride, int h, int x, int y);
        ...
        public void put_h264_chroma_mc2_c(byte[] dst_base /*align 8*/, int dst_offset, byte[] src_base /*align 1*/,
        ...
        public void put_h264_chroma_mc4_c(byte[] dst_base /*align 8*/, int dst_offset, byte[] src_base /*align 1*/,
            int src_offset, int stride, int h, int x, int y)
        {
            int A = (8 - x) * (8 - y);
            int B = x * (8 - y);
        ...
        public unsafe void put_h264_chroma_mc8_c(byte[] dst_base /*align 8*/, int dst_offset,
        ...
        //	static void OPNAME ## h264_chroma_mc2_c(uint8_t *dst/*align 8*/, uint8_t *src/*align 1*/, int stride, int h, int x, int y){
        public void avg_h264_chroma_mc2_c(byte[] dst_base /*align 8*/, int dst_offset, byte[] src_base /*align 1*/,
            int src_offset, int stride, int h, int x, int y)
        {
            int A = (8 - x) * (8 - y);
            int B = x * (8 - y);
        ...
        public static void copy_block(int size, byte[] dst_base, int dst_offset, byte[] src_base, int src_offset,
            ...
            int src_stride1, int src_stride2, int h)
        {
            ...
            else if (size == 4)
            {
                for (i = 0; i < h; i++)
                {
                    ...
                    //a= AV_RN32(&src1[i*src_stride1  ]);
                    //b= AV_RN32(&src2[i*src_stride2  ]);
                    a = (src1_base[src1_offset + i * src_stride1] << 0) |
                        (src1_base[src1_offset + i * src_stride1 + 1] << 8) |
                        (src1_base[src1_offset + i * src_stride1 + 2] << 16) |
                        (src1_base[src1_offset + i * src_stride1 + 3] << 24);
                    b = (src2_base[src2_offset + i * src_stride2] << 0) |
                        (src2_base[src2_offset + i * src_stride2 + 1] << 8) |
                        (src2_base[src2_offset + i * src_stride2 + 2] << 16) |
                        (src2_base[src2_offset + i * src_stride2 + 3] << 24);
                    c = (dst_base[dst_offset + i * dst_stride] << 0) |
                        (dst_base[dst_offset + i * dst_stride + 1] << 8) |
                        (dst_base[dst_offset + i * dst_stride + 2] << 16) |
                        (dst_base[dst_offset + i * dst_stride + 3] << 24);
                    if (opcode == 0) // PUT
                        c = rnd_avg32(a, b);
                    else // AVG
                        c = rnd_avg32(c, rnd_avg32(a, b));
            ...
            {
                pixels_l2(opcode, 8, dst_base, dst_offset, src1_base, src1_offset, src2_base, src2_offset, dst_stride,
                    src_stride1, src_stride2, h);
                pixels_l2(opcode, 8, dst_base, dst_offset + 8, src1_base, src1_offset + 8, src2_base, src2_offset + 8,
        ...
        public static void pixels_c(int opcode, int size, byte[] dst_base, int dst_offset, byte[] src_base,
            int src_offset, int stride, int height)
        {
            ...
            switch (size)
            {
                ...
                case 4:
                    ...
                    else
                    {
                        ...
                        {
                            long a = (src_base[src_offset] << 0) | (src_base[src_offset + 1] << 8) |
                                     (src_base[src_offset + 2] << 16) | (src_base[src_offset + 3] << 24);
                            long b = (dst_base[dst_offset] << 0) | (dst_base[dst_offset + 1] << 8) |
        ...
        public static void h264_qpel_h_lowpass(int opcode, int size, byte[] dst_base, int dst_offset, byte[] src_base,
            int src_offset, int dstStride, int srcStride)
        {
            switch (size)
            {
                case 2:
        ...
        public static void h264_qpel_v_lowpass(int opcode, int size, byte[] dst_base, int dst_offset, byte[] src_base,
            int src_offset, int dstStride, int srcStride)
        {
            switch (size)
            {
        ...
        public static void h264_qpel_mc00_c(int opcode, int size, byte[] dst_base, int dst_offset, byte[] src_base,
            int src_offset, int stride)
        {
            pixels_c(opcode, size, dst_base, dst_offset, src_base, src_offset, stride, size);
        }

        public static void h264_qpel_mc10_c(int opcode, int size, byte[] dst_base, int dst_offset, byte[] src_base,
            int src_offset, int stride)
        {
        ...
        public static void h264_qpel_mc20_c(int opcode, int size, byte[] dst_base, int dst_offset, byte[] src_base,
            int src_offset, int stride)
        {
            h264_qpel_h_lowpass(opcode, size, dst_base, dst_offset, src_base, src_offset, stride, stride);
        }

        public static void h264_qpel_mc30_c(int opcode, int size, byte[] dst_base, int dst_offset, byte[] src_base,
            int src_offset, int stride)
        {
            byte[] half = new byte[size * size];
            h264_qpel_h_lowpass(0, size, half, 0, src_base, src_offset, size, stride);
            pixels_l2(opcode, size, dst_base, dst_offset, src_base, src_offset + 1, half, 0, stride, stride, size,
                size);
        }

        public static void h264_qpel_mc01_c(int opcode, int size, byte[] dst_base, int dst_offset, byte[] src_base,
            int src_offset, int stride)
        {
        ...
        public static void h264_qpel_mc02_c(int opcode, int size, byte[] dst_base, int dst_offset, byte[] src_base,
            int src_offset, int stride)
        {
            byte[] full = new byte[size * (size + 5)];
            int full_mid = size * 2;
        ...
        public static void h264_qpel_mc03_c(int opcode, int size, byte[] dst_base, int dst_offset, byte[] src_base,
            int src_offset, int stride)
        {
            byte[] full = new byte[size * (size + 5)];
            int full_mid = size * 2;
        ...
        public static void h264_qpel_mc11_c(int opcode, int size, byte[] dst_base, int dst_offset, byte[] src_base,
            int src_offset, int stride)
        {
            byte[] full = new byte[size * (size + 5)];
            int full_mid = size * 2;
        ...
        public static void h264_qpel_mc31_c(int opcode, int size, byte[] dst_base, int dst_offset, byte[] src_base,
            int src_offset, int stride)
        {
            byte[] full = new byte[size * (size + 5)];
            int full_mid = size * 2;
        ...
        public static void h264_qpel_mc13_c(int opcode, int size, byte[] dst_base, int dst_offset, byte[] src_base,
            int src_offset, int stride)
        {
            byte[] full = new byte[size * (size + 5)];
            int full_mid = size * 2;
        ...
        public static void h264_qpel_mc33_c(int opcode, int size, byte[] dst_base, int dst_offset, byte[] src_base,
            int src_offset, int stride)
        {
            byte[] full = new byte[size * (size + 5)];
            int full_mid = size * 2;
        ...
        public static void h264_qpel_mc22_c(int opcode, int size, byte[] dst_base, int dst_offset, byte[] src_base,
            int src_offset, int stride)
        {
            short[] tmp = new short[size * (size + 5)];
            h264_qpel_hv_lowpass(opcode, size, dst_base, dst_offset, tmp, 0, src_base, src_offset, stride, size,
                stride);
        }

        public static void h264_qpel_mc21_c(int opcode, int size, byte[] dst_base, int dst_offset, byte[] src_base,
            int src_offset, int stride)
        {
            short[] tmp = new short[size * (size + 5)];
            byte[] halfH = new byte[size * size];
        ...
        public static void h264_qpel_mc23_c(int opcode, int size, byte[] dst_base, int dst_offset, byte[] src_base,
            int src_offset, int stride)
        {
            short[] tmp = new short[size * (size + 5)];
            byte[] halfH = new byte[size * size];
        ...
        public static void h264_qpel_mc12_c(int opcode, int size, byte[] dst_base, int dst_offset, byte[] src_base,
            int src_offset, int stride)
        {
            byte[] full = new byte[size * (size + 5)];
            int full_mid = size * 2;
        ...
        public static void h264_qpel_mc32_c(int opcode, int size, byte[] dst_base, int dst_offset, byte[] src_base,
            int src_offset, int stride)
        {
            byte[] full = new byte[size * (size + 5)];
            int full_mid = size * 2;
